...
const hyponyms = async (req, res) => {
	...
	startTime = performance.now()
	result = await dbNaryMethods.reltionValue(req.body.word, req.body.lang, req.body.limit, "hyponym")
	endTime = performance.now()
	time = new Number(endTime - startTime)
...
const hypernyms = async (req, res) => {
	...
	response.addData({ source: "BABELNET", inf: result, time: precise(time) })
	startTime = performance.now()
	result = await dbNaryMethods.reltionValue(req.body.word, req.body.lang, req.body.limit, "hypernym")
	endTime = performance.now()
	time = new Number(endTime - startTime)
	response.addData({ source: "DBNARY", inf: result, time: precise(time) })
	res.send(response)
...
const meronyms = async (req, res) => {
	...
	response.addData({ source: "BABELNET", inf: result, time: precise(time) })
	startTime = performance.now()
	result = await dbNaryMethods.reltionValue(req.body.word, req.body.lang, req.body.limit, "meronym")
	endTime = performance.now()
	time = new Number(endTime - startTime)
	response.addData({ source: "DBNARY", inf: result, time: precise(time) })
	startTime = performance.now()
...
const holonyms = async (req, res) => {
	...
	response.addData({ source: "BABELNET", inf: result, time: precise(time) })
	startTime = performance.now()
	result = await dbNaryMethods.reltionValue(req.body.word, req.body.lang, req.body.limit, "holonym")
	endTime = performance.now()
	time = new Number(endTime - startTime)
	response.addData({ source: "DBNARY", inf: result, time: precise(time) })
	startTime = performance.now()
